...
import {foundReportJuridico,resetReports} from './../../actions/reports'
import {setLoader} from './../../actions/loader'
import {setSearch} from './../../actions/search'
import SummaryJuridico from './../summaryJuridico'

class SearchJuridico extends Component {
    ...
    onValueChange = (event) => {
      ...
      handleClicked = () => {
        ...
        this.props.foundReportJuridico(this.state.value,localStorage.getItem('user'),this.props.headerNavegation + ' | Reporte: ' + this.state.value)
