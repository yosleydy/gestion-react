...
import {getReportsJuridico,getReportJuridico,resetReports} from './../../actions/reports'
...
import SummaryJuridico from './../summaryJuridico'
...
class juridico extends React.Component {
  ...
  handleClicked = (idReport,status) => {
    ...
    this.props.getReportJuridico(idReport,localStorage.getItem('user'),this.props.headerNavegation + ' | Reporte: ' + idReport, endpoint)
}
                        ...
                        <Table style = {{textAlign: 'center'}} className={classes.table}>
                            <TableHead >
                                <TableRow >                                        
                                    ...
                                    <TableCell id="tableHead" align="center">REGIÓN</TableCell>
                                    <TableCell id="tableHead" align="center" style={{"width":"13%"}}>RIF</TableCell>
                                    ...
                                    <TableCell id="tableHead" align="center">AGENTE DE RETENCIÓN</TableCell>
                                </TableRow>
                            </TableHead>
                            <TableBody>
                            {this.props.rows.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map(row => (
                                ...
                                <TableCell align="center"  style={{width: 54}}>
                                    {row.idReport}
                                </TableCell>
                                <TableCell align="center" >{row.idRegion}</TableCell>
                                <TableCell align="center" >{row.custPrefixId}-{row.custId}</TableCell>
                               ...
                               <TableCell align="center" >{row.transferDate.split("-").reverse().join("/")}</TableCell>
                                ...
                                <TableCell align="center">{
                                 ...
                                 <TableCell align="center">{
                                    row.retentionStatus === 0 ? 'NO VERIFICADO' :  
                                    row.retentionStatus === 1 ? 'APLICADO' :  
                                    row.retentionStatus === 2 ? 'NO APLICADO':''
                                }</TableCell>
                                <TableCell align="center">{row.retentionAgent}</TableCell>
...
function mapStateToProps(state) {
  ...
  const Juridico = withStyles(styles, { withTheme: true })(juridico);
